...
export default function Dashboard() {
  ...
  return (
    <div className="dashboard">
      ...
      {currentView === 'matrix' && <MatrixView tasks={tasks} onToggle={handleToggle} onDelete={handleDelete} />}
      {currentView === 'list'   && <ListView   tasks={tasks} onToggle={handleToggle} onDelete={handleDelete} />}
      {currentView === 'status' && <StatusView tasks={tasks} onToggle={handleToggle} onDelete={handleDelete} />}
...
function MatrixView({ tasks, onToggle, onDelete }) {
  return (
